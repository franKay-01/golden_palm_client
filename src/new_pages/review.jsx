      ...
      <>
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <div className="text-center">
            <h1 className="text-4xl font-caslon text-gp-light-green mb-4">Order Not Found</h1>
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-6xl font-caslon text-gp-light-green mb-4">
            Share Your Experience
          </h1>
          <p className="text-gray-600 font-canaro-book text-lg">
            Order #{orderInfo.order_reference}
          </p>
          <p className="text-gray-500 font-canaro-light">
            Placed on {new Date(orderInfo.created_at).toLocaleDateString()}
          </p>
          <p className="text-gray-600 font-canaro-light mt-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-50 rounded-lg p-6 sticky top-4">
              <h2 className="text-2xl font-caslon text-gp-light-green mb-4">Order Summary</h2>

              <div className="space-y-3 mb-6">
                <div className="flex justify-between font-canaro-book text-sm">
                ...
                <div className="flex justify-between font-canaro-semibold border-t pt-3">
                  <span className="text-gray-700">Total:</span>
                  <span className="text-gp-light-green text-lg">${parseFloat(orderInfo.total_amount).toFixed(2)}</span>
                </div>
              </div>

              {/* Order Items List */}
              <div className="border-t pt-4">
                <h3 className="font-canaro-semibold text-gray-700 mb-3">Items in Order</h3>
                  ...
                  {orderItems?.map((item) => (
                    <div key={item.order_item_reference_no} className="flex gap-3 pb-3 border-b last:border-b-0">
                      ...
                      <div className="flex-1">
                        <p className="font-canaro-semibold text-sm text-gray-900">
                          {item.itemDetails?.name || item.desc}
                        </p>
                        <p className="text-xs text-gray-600 font-canaro-light">
                          Qty: {item.quantity} × ${parseFloat(item.unit_amount).toFixed(2)}
                        </p>
                        {item.heat_level && (
                          <p className="text-xs text-gray-500 font-canaro-light">
          ...
          <div className="lg:col-span-2">
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="bg-white border border-gray-200 rounded-lg p-8">
                <h2 className="text-3xl font-caslon text-gp-light-green mb-6">Rate Your Order</h2>

                {/* Star Rating */}
                <div className="mb-8">
                  <label className="block text-gray-700 font-canaro-semibold mb-3 text-lg">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gp-light-green font-canaro-book"
                    rows="6"
                    // maxLength={300}
                    maxLength={maxChars}
                  />
                ...
                <div className="mt-8">
                  <button
                    ...
                    className="w-full bg-gp-light-green text-white px-12 py-4 rounded-lg text-lg font-canaro-semibold hover:bg-green-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
